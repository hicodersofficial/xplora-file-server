<div class="card__group">
    <?php for ($i = 0; $i  < count($files); $i++) : ?>
        ...
        $ext_name = strtolower($split_name[count($split_name) - 1]);
        $rendered = false;

        $is_dir = is_dir($ROOT_PATH . $src);
        $filesize = 0;
        if (is_file($ROOT_PATH . $src)) {
            $size_in_mb = filesize($ROOT_PATH . $src) / 1024 / 1024;
        ...
        <div class="card">
            ...
            <?php if (in_array($ext_name, IMG_EXTS)) : ?>
                <img src="<?php echo $ROOT_PATH . $src
            ...
            <div style="width: 100%;">
                ...
                <?php if ($is_dir) : ?>
                    <a href="?dir=<?php echo $ROOT_PATH . $src ?>" class="btn btn-primary open" style="width: 100%;border-radius: 0;">Open</a>
                <?php else : ?>
